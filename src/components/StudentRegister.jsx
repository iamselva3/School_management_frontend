        ...
        <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-950 py-12 px-4 overflow-hidden relative transition-colors duration-500">
            ...
            >
                <div className="text-center mb-10">
                    <motion.div 
                        whileHover={{ scale: 1.1, rotateY: 360, borderRadius: "40%" }}
                        transition={{ duration: 0.8, type: "spring" }}
                        className="inline-flex items-center justify-center w-24 h-24 bg-indigo-600 rounded-[2.5rem] mb-8 shadow-2xl shadow-indigo-100 dark:shadow-none"
                    >
